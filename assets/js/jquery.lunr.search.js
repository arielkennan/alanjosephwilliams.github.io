(function($) {
  ...
  var LunrSearch = (function() {
    ...
    LunrSearch.prototype.displayResults = function(entries) {
      ...
      if (entries.length === 0) {
        $entries.append('<div class="alert alert-warning">Nothing found! Have something to contribute? Get in touch here.</div>')
  ...
  $.fn.lunrSearch.defaults = {
    indexUrl  : '/designgov-2/search.json',     // Url for the .json file containing search index source data (containing: title, url, date, body)
